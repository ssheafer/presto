...
public class FilterAndProjectOperator2
        implements Operator
{
    ...
    public FilterAndProjectOperator2(OperatorContext operatorContext, Iterable<? extends Type> types, PageProcessor processor)
    {
    ...
    public static class FilterAndProjectOperatorFactory2
            implements OperatorFactory
    {
        ...
        public FilterAndProjectOperatorFactory2(int operatorId, PageProcessor processor, List<Type> types)
        {
        ...
        public Operator createOperator(DriverContext driverContext)
        {
            ...
            return new FilterAndProjectOperator2(operatorContext, types, processor);
        }
