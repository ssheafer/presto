...
import static com.facebook.presto.operator.FilterAndProjectOperator2.FilterAndProjectOperatorFactory2;
...
public class DynamicTupleFilterFactory
{
    ...
    public OperatorFactory filterWithTuple(Page tuplePage)
    {
        ...
        return new FilterAndProjectOperatorFactory2(filterOperatorId, processor, outputTypes);
    }
