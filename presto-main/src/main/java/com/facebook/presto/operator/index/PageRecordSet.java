        ...
        implements RecordSet
{
            ...
            implements RecordCursor
    {
        ...
        public boolean getBoolean(int field)
        {
            ...
            return page.getBlock(field).getBoolean(position);
        }
        ...
        public long getLong(int field)
        {
            checkState(position >= 0, "Not yet advanced");
            checkState(position < page.getPositionCount(), "Already finished");
            return page.getBlock(field).getLong(position);
        }
        ...
        public double getDouble(int field)
        {
            checkState(position >= 0, "Not yet advanced");
            checkState(position < page.getPositionCount(), "Already finished");
            return page.getBlock(field).getDouble(position);
        }
        ...
        public Slice getSlice(int field)
        {
            checkState(position >= 0, "Not yet advanced");
            checkState(position < page.getPositionCount(), "Already finished");
            return page.getBlock(field).getSlice(position);
        }
