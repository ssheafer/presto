...
public class TestTupleFilterProcessor
{
            ...
            throws Exception
    {
        ...
        ConnectorSession session = new ConnectorSession("user", "source", "catalog", "schema", TimeZoneKey.UTC_KEY, Locale.ENGLISH, "127.0.0.1", "userAgent");
        ...
        assertPageEquals(actualPage, expectedPage);
    }
