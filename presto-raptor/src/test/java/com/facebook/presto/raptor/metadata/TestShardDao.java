...
public class TestShardDao
{
            ...
            throws Exception
    {
        ...
        long plainTableId = metadataDao.insertTable("test", "plain", false, false, null);
        long bucketedTableId = metadataDao.insertTable("test", "bucketed", false, false, distributionId);
