...
public class TestShardOrganizationManager
{
    ...
    public void testOrganizationEligibleTables()
            throws Exception
    {
        long table1 = metadataDao.insertTable("schema", "table1", false, true, null);
        metadataDao.insertColumn(table1, 1, "foo", 1, "bigint", 1, null);

        metadataDao.insertTable("schema", "table2", false, true, null);
        metadataDao.insertTable("schema", "table3", false, false, null);
            ...
            throws Exception
    {
        ...
        long table2 = metadataDao.insertTable("schema", "table2", false, true, null);
